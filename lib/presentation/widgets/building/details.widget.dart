      ...
      child: Column(
        ...
        children: [
          Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                Text(mes,style: const TextStyle(color: Colors.black,fontFamily: Config.poppingSemiBold,fontSize: 16.0),), 
                Text(fechaFormat,style: const TextStyle(color: Config.textColorIconButton,fontFamily: Config.poppingSemiBold,fontSize: 12.0))]),
